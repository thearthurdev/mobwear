...
List<PhoneModel> iPhonePhonesList = [
  PhoneModel(id: 0200, phone: IPhone8Plus()),
  PhoneModel(id: 0201, phone: IPhoneXR()),
  PhoneModel(id: 0202, phone: IPhoneXSMax()),
  PhoneModel(id: 0203, phone: IPhone11()),
  PhoneModel(id: 0204, phone: IPhone11ProMax()),
];
